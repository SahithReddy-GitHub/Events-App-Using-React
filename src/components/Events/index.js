...
class Events extends Component {
  state = {registrationStatus: registrationStatusConstants.noActiveEvent}

  onClickEvent = regStatus => {
    this.setState({registrationStatus: regStatus})
  }
      ...
      <div className="bg-custom">
        ...
        <div className="reg-con">
          <ActiveEventRegistrationDetails
            registrationStatusConstants={registrationStatusConstants}
